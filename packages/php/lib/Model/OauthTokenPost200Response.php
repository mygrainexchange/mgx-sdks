...
/**
 * OauthTokenPost200Response Class Doc Comment
 *
 * @category Class
 * @package  MyGrainExchange\Mgx
 * @author   OpenAPI Generator team
 ...
 */
class OauthTokenPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_oauth_token_post_200_response';
    ...
    */
     ...
     * Sets expiresIn
     *
     * @param int|null $expiresIn Access token lifetime in seconds (15 days).
     *
     * @return self
     */
     ...
     * Sets refreshToken
     *
     * @param string|null $refreshToken Omitted for the client_credentials grant.
     *
     * @return self
     */
