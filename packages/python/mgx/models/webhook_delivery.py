...
class WebhookDelivery(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "event", "status", "response_code", "attempted_at", "payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": WebhookEvent.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
