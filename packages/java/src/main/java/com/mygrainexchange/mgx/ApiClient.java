...
import com.mygrainexchange.mgx.auth.Authentication;
import com.mygrainexchange.mgx.auth.HttpBasicAuth;
import com.mygrainexchange.mgx.auth.HttpBearerAuth;
import com.mygrainexchange.mgx.auth.ApiKeyAuth;
import com.mygrainexchange.mgx.auth.OAuth;
import com.mygrainexchange.mgx.auth.RetryingOAuth;
import com.mygrainexchange.mgx.auth.OAuthFlow;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.mygrainexchange.com/v1";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.mygrainexchange.com/oauth/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.mygrainexchange.com/v1
     ...
     * @return a {@link com.mygrainexchange.mgx.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.mygrainexchange.mgx.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.mygrainexchange.mgx.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.mygrainexchange.mgx.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.mygrainexchange.mgx.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.mygrainexchange.mgx.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.mygrainexchange.mgx.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.mygrainexchange.mgx.ApiException If fails to update the parameters
     */
     ...
     * @throws com.mygrainexchange.mgx.ApiException If fail to serialize the request body object into a string
     */
