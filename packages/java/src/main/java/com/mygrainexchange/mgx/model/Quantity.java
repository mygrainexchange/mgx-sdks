...
public class Quantity {
  ...
  public Quantity amount(@javax.annotation.Nullable BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public Quantity unit(@javax.annotation.Nullable UnitEnum unit) {
    this.unit = unit;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("amount", "unit"));
